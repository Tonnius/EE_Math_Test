...
class ProfileController extends BaseController {
	...
	public function GetProfileInfo()
	{
		...
		return View::make('profiil', array('results' => $results, 'count' => $count, 'user' => Auth::user()));
	}

	public function GetProfileInfoForUser(User $user)
	{
		$results = DB::select('select * from testhastasks
								inner join tests
								on testhastasks.test_id=tests.id
		...
		return View::make('profiil', array('results' => $results, 'count' => $count, 'user' => $user));
	}
	...
	public function GetAllUsers()
	{
		...
		return View::make('students', array('data' => $data));
	}
